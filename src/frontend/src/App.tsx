          ...
          >
            <div className="flex items-baseline gap-3 mb-1">
              ...
              <motion.span
                ...
                className={`font-sans text-sm font-medium px-2 py-0.5 rounded-full border ${activeCount === 0 ? "text-green-600 bg-green-100 border-green-200 dark:text-green-400 dark:bg-green-900/30 dark:border-green-800" : "text-accent bg-accent/10 border-accent/20"}`}
              >
                {activeCount} left
              </motion.span>
            </div>
